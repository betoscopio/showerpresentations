This is based on the work of @codepo8 and @pepelsbey.
I made some small modifications to the defined shower themes for my presentations at the Drupal summit Latino, http://loja2013.dlatino.org/.
- Introducción a Drupal.
- PHP está mejorando, y cómo Drupal está ayudando ello.
Para ver las presentaciones, solo clona este repositorio y abre los archivos con este navegador.
